...
class DefenseLoss:
    def __init__(self, model, unormalize=False, to_pytorch=False):
        self.model = model
        # self.true = true
        self.unormalize = unormalize
        self.to_pytorch = to_pytorch
    ...
    def __call__(self, img, true):
        ...
        is_adversarial = True if y != true else False

        f_true = math.log(math.exp(preds[true]) + 1e-30)
